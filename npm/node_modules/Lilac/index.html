                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4 has-sep hidden-sm">
                            <div class="custom-menu-right">
                              ...
                              <div class="box-banner media">
                                <div class="add-right"><img src="images/menu-img3.jpg" alt=""></div>
                              </div>
                            </div>
                          </div>
                        </div>
      ...
      <div class="row">
        <div class="col-sm-9 col-sm-push-3">
          <div style="overflow:hidden">
            <div class="figure banner-with-effects effect-sadie1 banner-width  with-button" style="background-color:#ffffff"><img src="images/watch.jpg" alt="">
            ...
            <div class="figure banner-with-effects effect-sadie1 banner-width  with-button" style="background-color:#ffffff"><img src="images/shoes-banner.jpg" alt="">
              <div class="figcaption">
                        ...
                        <div class="category-products">
                          ...
                          <div class="item-info">
                            ...
                            <li class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                              <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.html"> <img alt="Retis lapen casen" src="products-images/product19.jpg"> </a>
                              <div class="new-label new-top-left">new</div>
                              <div class="box-hover">
                                <ul class="add-to-links">
                                  <li><a class="link-quickview" href="quick_view.html"></a> </li>
          ...
          <div class="hot-deal">
            <ul class="products-grid">
              <li class="right-space two-height item">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a href="#" title="Retis lapen casen" class="product-image"> <img src="products-images/product9.jpg" alt="Retis lapen casen"> </a>
